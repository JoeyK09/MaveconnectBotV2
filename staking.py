...
def buy_plats_nudge_markup():
    """
    Same 'Buy Plats Now' button used elsewhere in the bot — tapping it fires
    the quick_buy_plats callback handler already registered in bot.py, so
    nothing needs to be duplicated here.
    """
    markup = InlineKeyboardMarkup()
    markup.add(InlineKeyboardButton("💵 Buy Plats Now", callback_data="quick_buy_plats"))
    return markup
